...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
  ...
  */
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
    	...
    	com.thp.spring.simplecontext.security.UserPrincipal principal = (com.thp.spring.simplecontext.security.UserPrincipal) authResult.getPrincipal();
        ...
        //HMAC512: algorithm to sign with
               String token = JWT.create()
                ...
                .sign(HMAC512(com.thp.spring.simplecontext.security.JwtProperties.SECRET.getBytes())); // SECRET : stored in JWT properties

        // Add token in response

        //HEADER_STRING : authorization header
        //TOKEN_PREFIX : Bearer
        response.addHeader(com.thp.spring.simplecontext.security.JwtProperties.HEADER_STRING, com.thp.spring.simplecontext.security.JwtProperties.TOKEN_PREFIX + token);
